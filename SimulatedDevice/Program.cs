...
namespace SimulatedDevice
{
    ...
    internal class Program
    {
        ...
        private static string s_connectionString = "HostName=UjunwaMotionSensorHubv2.azure-devices.net;DeviceId=ujunwa_simdevice;SharedAccessKey=eA9vU5W2ysL82NyMx3YgzuMnNP9aICl2waD13gQPKNo=";
        ...
        private static async Task SendDeviceToCloudMessagesAsync(CancellationToken ct)
        {
            ...
            double minlatitude = 37.7749;
            double minlongitude = -122.4194;
            double direction = 180.0;
            DateTime timestamp = new DateTime(2022, 4, 27, 22, 21, 0, 5);
            string location = "livingroom";
            double sensorId = 2345670;
            ...
            {
                double currentlatitude = minlatitude + rand.NextDouble() * 20;
        double currentlongitude = minlongitude + rand.NextDouble() * -50;
        double currentdirection = direction + rand.NextDouble() * 180.0;
        DateTime currenttimestamp = timestamp.AddSeconds(rand.NextDouble() * 3600.0);
        string currentlocation = location + rand.Next(1, 5);
        double currentsensorId = sensorId + rand.NextDouble() * 2345670;
                ...
                message.Properties.Add("latitudeAlert", (currentlongitude > 30) ? "true" : "false");
